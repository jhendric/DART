...
integer, parameter, public :: &
  KIND_TEMPERATURE_ELECTRON          = 88, &
  KIND_TEMPERATURE_ION               = 89, &
  KIND_DENSITY_NEUTRAL_O3P           = 90, &
  KIND_DENSITY_NEUTRAL_O2            = 91, &
  KIND_DENSITY_NEUTRAL_N2            = 92, &
  KIND_DENSITY_NEUTRAL_N4S           = 93, &
  KIND_DENSITY_NEUTRAL_NO            = 94, &
  KIND_DENSITY_NEUTRAL_N2D           = 95, &
  ...
  KIND_DENSITY_ION_N2P               = 103, &
  KIND_DENSITY_ION_NP                = 104, &
  KIND_DENSITY_ION_NOP               = 105, &
  KIND_DENSITY_ION_O2DP              = 106, &
  KIND_DENSITY_ION_O2PP              = 107, &
  KIND_DENSITY_ION_HP                = 108, &
  KIND_DENSITY_ION_HEP               = 109, &
  KIND_DENSITY_ION_E                 = 110, &
  KIND_VELOCITY_U                    = 111, &
  KIND_VELOCITY_V                    = 112, &
  KIND_VELOCITY_W                    = 113, &
  KIND_VELOCITY_U_ION                = 114, &
  KIND_VELOCITY_V_ION                = 115, &
  KIND_VELOCITY_W_ION                = 116, &
  KIND_VELOCITY_VERTICAL_O3P         = 117, &
  KIND_VELOCITY_VERTICAL_O2          = 118, &
...
!! declaration.
integer, parameter :: max_obs_generic = 122
...
obs_kind_names(88) = obs_kind_type(KIND_TEMPERATURE_ELECTRON, 'KIND_TEMPERATURE_ELECTRON')
obs_kind_names(89) = obs_kind_type(KIND_TEMPERATURE_ION, 'KIND_TEMPERATURE_ION')
obs_kind_names(90) = obs_kind_type(KIND_DENSITY_NEUTRAL_O3P, 'KIND_DENSITY_NEUTRAL_O3P')
obs_kind_names(91) = obs_kind_type(KIND_DENSITY_NEUTRAL_O2, 'KIND_DENSITY_NEUTRAL_O2')
obs_kind_names(92) = obs_kind_type(KIND_DENSITY_NEUTRAL_N2, 'KIND_DENSITY_NEUTRAL_N2')
obs_kind_names(93) = obs_kind_type(KIND_DENSITY_NEUTRAL_N4S, 'KIND_DENSITY_NEUTRAL_N4S')
obs_kind_names(94) = obs_kind_type(KIND_DENSITY_NEUTRAL_NO, 'KIND_DENSITY_NEUTRAL_NO')
obs_kind_names(95) = obs_kind_type(KIND_DENSITY_NEUTRAL_N2D, 'KIND_DENSITY_NEUTRAL_N2D')
...
obs_kind_names(103) = obs_kind_type(KIND_DENSITY_ION_N2P, 'KIND_DENSITY_ION_N2P')
obs_kind_names(104) = obs_kind_type(KIND_DENSITY_ION_NP, 'KIND_DENSITY_ION_NP')
obs_kind_names(105) = obs_kind_type(KIND_DENSITY_ION_NOP, 'KIND_DENSITY_ION_NOP')
obs_kind_names(106) = obs_kind_type(KIND_DENSITY_ION_O2DP, 'KIND_DENSITY_ION_O2DP')
obs_kind_names(107) = obs_kind_type(KIND_DENSITY_ION_O2PP, 'KIND_DENSITY_ION_O2PP')
obs_kind_names(108) = obs_kind_type(KIND_DENSITY_ION_HP, 'KIND_DENSITY_ION_HP')
obs_kind_names(109) = obs_kind_type(KIND_DENSITY_ION_HEP, 'KIND_DENSITY_ION_HEP')
obs_kind_names(110) = obs_kind_type(KIND_DENSITY_ION_E, 'KIND_DENSITY_ION_E')
obs_kind_names(111) = obs_kind_type(KIND_VELOCITY_U, 'KIND_VELOCITY_U')
obs_kind_names(112) = obs_kind_type(KIND_VELOCITY_V, 'KIND_VELOCITY_V')
obs_kind_names(113) = obs_kind_type(KIND_VELOCITY_W, 'KIND_VELOCITY_W')
obs_kind_names(114) = obs_kind_type(KIND_VELOCITY_U_ION, 'KIND_VELOCITY_U_ION')
obs_kind_names(115) = obs_kind_type(KIND_VELOCITY_V_ION, 'KIND_VELOCITY_V_ION')
obs_kind_names(116) = obs_kind_type(KIND_VELOCITY_W_ION, 'KIND_VELOCITY_W_ION')
obs_kind_names(117) = obs_kind_type(KIND_VELOCITY_VERTICAL_O3P, 'KIND_VELOCITY_VERTICAL_O3P')
obs_kind_names(118) = obs_kind_type(KIND_VELOCITY_VERTICAL_O2, 'KIND_VELOCITY_VERTICAL_O2')
