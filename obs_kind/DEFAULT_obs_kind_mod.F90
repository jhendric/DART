...
integer, parameter, public :: &
  KIND_ELECTRON_TEMPERATURE          = 88, &
  KIND_ION_TEMPERATURE               = 89, &
  KIND_U_VELOCITY                    = 90, &
  KIND_V_VELOCITY                    = 91, &
  KIND_W_VELOCITY                    = 92, &
  KIND_ION_U_VELOCITY                = 93, &
  KIND_ION_V_VELOCITY                = 94, &
  KIND_ION_W_VELOCITY                = 95, &
  KIND_NEUTRAL_DENSITY               = 96, &
  KIND_ION_DENSITY                   = 97, &
  KIND_iO_3P_VERTICALVELOCITY        = 98, &
  KIND_iNO_VERTICALVELOCITY          = 99, &
  KIND_TOTAL_ELECTRON_CONTENT        = 100
 
!! PRIVATE ONLY TO THIS MODULE. see comment below near the max_obs_specific
!! declaration.
integer, parameter :: max_obs_generic = 100
...
obs_kind_names(88) = obs_kind_type(KIND_ELECTRON_TEMPERATURE, 'KIND_ELECTRON_TEMPERATURE')
obs_kind_names(89) = obs_kind_type(KIND_ION_TEMPERATURE, 'KIND_ION_TEMPERATURE')
obs_kind_names(90) = obs_kind_type(KIND_U_VELOCITY, 'KIND_U_VELOCITY')
obs_kind_names(91) = obs_kind_type(KIND_V_VELOCITY, 'KIND_V_VELOCITY')
obs_kind_names(92) = obs_kind_type(KIND_W_VELOCITY, 'KIND_W_VELOCITY')
obs_kind_names(93) = obs_kind_type(KIND_ION_U_VELOCITY, 'KIND_ION_U_VELOCITY')
obs_kind_names(94) = obs_kind_type(KIND_ION_V_VELOCITY, 'KIND_ION_V_VELOCITY')
obs_kind_names(95) = obs_kind_type(KIND_ION_W_VELOCITY, 'KIND_ION_W_VELOCITY')
obs_kind_names(96) = obs_kind_type(KIND_NEUTRAL_DENSITY, 'KIND_NEUTRAL_DENSITY')
obs_kind_names(97) = obs_kind_type(KIND_ION_DENSITY, 'KIND_ION_DENSITY')
obs_kind_names(98) = obs_kind_type(KIND_iO_3P_VERTICALVELOCITY, 'KIND_iO_3P_VERTICALVELOCITY')
obs_kind_names(99) = obs_kind_type(KIND_iNO_VERTICALVELOCITY, 'KIND_iNO_VERTICALVELOCITY')
obs_kind_names(100) = obs_kind_type(KIND_TOTAL_ELECTRON_CONTENT, 'KIND_TOTAL_ELECTRON_CONTENT')
