...
integer, parameter, public :: &
    KIND_INTEGRATED_SULFATE          = 88, & 
    KIND_INTEGRATED_DUST             = 89, &
    KIND_INTEGRATED_SMOKE            = 90, &
    KIND_INTEGRATED_SEASALT          = 91, &
    KIND_INTEGRATED_AOD              = 92, &
    KIND_SO2                         = 93, & 
    KIND_SULFATE                     = 94, & 
    KIND_DUST                        = 95, &
    KIND_SMOKE                       = 96, &
...
obs_kind_names(88) = obs_kind_type(KIND_INTEGRATED_SULFATE, 'KIND_INTEGRATED_SULFATE')
obs_kind_names(89) = obs_kind_type(KIND_INTEGRATED_DUST, 'KIND_INTEGRATED_DUST')
obs_kind_names(90) = obs_kind_type(KIND_INTEGRATED_SMOKE, 'KIND_INTEGRATED_SMOKE')
obs_kind_names(91) = obs_kind_type(KIND_INTEGRATED_SEASALT, 'KIND_INTEGRATED_SEASALT')
obs_kind_names(92) = obs_kind_type(KIND_INTEGRATED_AOD, 'KIND_INTEGRATED_AOD')
obs_kind_names(93) = obs_kind_type(KIND_SO2, 'KIND_SO2')
obs_kind_names(94) = obs_kind_type(KIND_SULFATE, 'KIND_SULFATE')
obs_kind_names(95) = obs_kind_type(KIND_DUST, 'KIND_DUST')
obs_kind_names(96) = obs_kind_type(KIND_SMOKE, 'KIND_SMOKE')
obs_kind_names(97) = obs_kind_type(KIND_SEASALT, 'KIND_SEASALT')
