...
!  use obs_def_upper_atm_mod, only : get_expected_upper_atm_density, get_expected_gnd_gps_vtec
...
implicit none
private
public                    :: get_expected_upper_atm_density, get_expected_gnd_gps_vtec
